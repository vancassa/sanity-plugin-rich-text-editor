...
const editorContainerVariants = cva(
  'relative w-full cursor-text overflow-y-auto select-text focus-visible:outline-none [&_.slate-selection-area]:z-50 [&_.slate-selection-area]:border [&_.slate-selection-area]:border-black [&_.slate-selection-area]:bg-black/15',
  {
    defaultVariants: {
      variant: 'default',
    },
  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        default: 'px-8 pt-8 pb-60 text-base',
